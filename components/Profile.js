            ...
            <div className="flex gap-8 mt-12 pb-12 items-start mb-18 border-b-2 border-gray-300 flex-col md:flex-row" data-name="profile-section">
                ...
                <div className="flex-1 flex flex-col items-start gap-4 mt-7" data-name="profile-info">
                    <div className="flex flex-col md:flex-row gap-8 w-full" data-name="profile-text-and-icons">
                        ...
                        <a href="https://www.behance.net/dumyak_graphics" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group cursor-pointer">
                            ...
                            <span className="text-gray-600 hover:text-gray-900 transition-colors">Behance portfolio</span>
                            </a>

                            <div className="flex items-center gap-3 group cursor-pointer" data-name="phone-number">
                                <span className="flex items-center justify-center w-10 h-10 rounded-lg bg-gray-900 text-white transition-colors group-hover:bg-gray-800 border-2 border-white cursor-pointer">
                            ...
                            <div className="flex items-center gap-3 group cursor-pointer" data-name="linkedin-link">
                                <span className="flex items-center justify-center w-10 h-10 rounded-lg bg-gray-900 text-white font-semibold text-sm transition-colors group-hover:bg-gray-800 border-2 border-white cursor-pointer">
                                    in
                                </span>
                                <a href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQF6xb8tlE-YDgAAAZVlgTs4U9EiPuYXKiv6NiJDrlEJ6ihSeP6vC-xRzNcLvWR_m4if5LEm9uyHlfyqroRAQJgj53Vqwa37ZPCwDA3ex_WsO2IPrXJc0IcvxRGv3CJSW1phviA=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fsofiia-dumiak-159986234%3Futm_source%3Dshare%26utm_campaign%3Dshare_via%26utm_content%3Dprofile%26utm_medium%3Dios_app" className="text-gray-600 hover:text-gray-900 transition-colors">LinkedIn Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
