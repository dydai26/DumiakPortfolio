function Contact() {
    ...
    const [messages, setMessages] = React.useState([
        ...
        { id: 3, name: "Lina Baciu", message: "Amazing portfolio! Would love to collaborate on a project.", date: "2024-12-10" },
        { id: 4, name: "Cris Dulger", message: "Your design work is truly inspiring. The attention to detail is remarkable.", date: "2024-11-20" }
    ]);
